...
const FriendsList = ({ propBackgroundColor, onFrameContainer11Click }) => {
  ...
  return (
    <div className="self-stretch flex-1  overflow-y-scroll  flex flex-col items-start justify-start text-left text-[1rem] text-gray-100 font-rubik">
      <div className="self-stretch   flex flex-row p-[0.94rem] items-center justify-start gap-[0.63rem] border-b-[1px] border-0 border-solid border-seagreen-200">
        <img
      ...
      <div
        className="self-stretch   flex flex-row p-[0.94rem] items-center justify-start gap-[0.63rem] cursor-pointer border-b-[1px] border-0 border-solid border-seagreen-200"
